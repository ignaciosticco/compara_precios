...
def extrae_producto_y_precio(texto):
	...
	lista_texto_dividido = [x for x in lista_texto_dividido if x] # saco los elementos vacios
	producto_precio = []
...
def imprime_lista_precios(producto_precio):
	'''
...
def main():
	...
	producto_precio = extrae_producto_y_precio(texto_data_productos)
	imprime_lista_precios(producto_precio)
